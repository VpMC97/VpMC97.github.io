...
const Header = ({parentMethod}) => {
    return (
        <header className="header">
            <div className="theme-switch">
                <input className="checked" type="checkbox" id="theme-checkbox" onClick={parentMethod}/>
                <label className="switch-label" htmlFor="theme-checkbox">
                    <div></div>
                    <span>
